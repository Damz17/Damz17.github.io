...
<head>
    ...
    <title>
   Free Dns - Free Hosting - Free Subdomain - Adamm
    </title>
...
<body>
    <div class="app">
        ...
        <h1>Damz<strong>GAGAH</strong>Fzh</h1>
        ...
        <span class="alert success"><i class="fa fa-check-circle" aria-hidden="true"></i>Success, Lain Kali Modal Dek!</span>
        <span class="alert failed"><i class="fa fa-check-circle" aria-hidden="true"></i>Wrong Ip/Domain</span>
        <span class="alert process"><i class="fa fa-cog fa-spin" aria-hidden="true"></i>Sabar Dek!</span>
        ...
        <div class="inner">
            ...
            <div class="domains">.official2022.xyz</div>
        </div>
        ...
        <div class="inner">
            <input class="input" type="text" name="ip" placeholder="IP SERVER LU BRO" style="display:none" autocomplete="off">
        </div>
        ...
        <div class="details">
            ...
            <div class="active">
                <p class="info">Terima kasih, telah menggunakan domain dari Damz</p>
            </div>
        </div>

        <span class="copy">Maded With 🐊 By Adam</span>
    </div>
    ...
    <script>
        function fun(){
                ...
                $('.process').fadeIn();
                $.get('docs/lookup.php?domain='+domain.val()+'.official2022.xyz',function(r){
                    if(!r.is_exsist){
                        $('.process').hide();
                        $('#query').fadeIn();
        ...
        function change(){
            ...
            $.get('docs/add_domain.php?session='+session+'&domain='+domain.val()+'.official2022.xyz&ip='+ip,function(r){
                console.log(r)
                    if(r.success){
                        $('.process').hide();
                        $('.success').fadeIn();
                        ...
                        $('#domain').text($('input[name="domain"]').val()+'.official2022.xyz');
                        $('.details').fadeIn();
                        $('.check').hide();
                    }else{
                        $('.mistake').fadeIn();
